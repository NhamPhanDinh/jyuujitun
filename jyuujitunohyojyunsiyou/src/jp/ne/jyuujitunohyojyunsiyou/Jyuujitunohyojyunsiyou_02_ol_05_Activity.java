 ...
 * 
 */
public class Jyuujitunohyojyunsiyou_02_ol_05_Activity extends Activity
		implements OnClickListener {
	ImageButton btn_back, btn_showtab, btn_bottom;
	TabHost mTabHost;
	LinearLayout layout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jyuujitunohyojyunsiyou_02_ol_05);
		ini();
		// get data from XML
